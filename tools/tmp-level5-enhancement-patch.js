...
function once(oldText,newText,label){if(!s.includes(oldText))throw new Error('missing expected Desert source for '+label);s=s.replace(oldText,newText);}
