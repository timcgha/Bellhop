...
ok(JSON.parse(fs.readFileSync(path.join(ROOT,'release.json'),'utf8')).display==='v61 · Movement and Jump Feel',
  'canonical release metadata advances to v61 · Movement and Jump Feel');
